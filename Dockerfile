...
ENV SCHEMA DBT_RCLAYTON
ENV SF_SKILL_WORD_TABLE SKILL_MATCHER_WORDS
ENV SF_TECHNOLOGY_WORD_TABLE TECHNOLOGY_MATCHER_WORDS
ENV SF_MATCH_COLUMN_SKILLS SKILL_WORDS
ENV SF_MATCH_COLUMN_TECHNOLOGY TECHNOLOGY_WORDS
